...
class DataProcessor:
    ...
    def _combine_raw_data(self):
        ...
        file_paths = [os.path.join(raw_data_dir, f) for f in os.listdir(raw_data_dir) if f.endswith('.csv') and f.startswith('power_demand_')]
    ...
    def process_raw_data(self):
        ...
        train_df.to_csv(os.path.join(processed_dir, data_config['train_filename']), index=False)
        stream_df.to_csv(os.path.join(processed_dir, data_config['stream_filename']), index=False)
